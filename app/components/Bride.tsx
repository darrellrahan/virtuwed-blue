  ...
  return (
    <section id="bride" className="relative">
      ...
      <div className="text-[#D5AF6F] z-20 relative lg:grid lg:grid-cols-2 lg:h-screen">
        <span className="text-[#D5AF6F] text-3xl font-semibold absolute bottom-8 left-8 hidden lg:block z-10">
          Putra dari
          <br />
          Bapak Agus
          <br />
        ...
        <span className="text-[#D5AF6F] text-3xl font-semibold absolute bottom-8 right-8 hidden lg:block z-10 text-right">
          Putra dari
          <br />
          Bapak Agus
          <br />
        ...
        <div className="h-full lg:bg-[url('/assets/bride.svg')] lg:bg-cover lg:bg-no-repeat lg:bg-center relative lg:flex lg:items-center lg:justify-center">
          ...
          <div className="py-12 font-bold space-y-4 text-center z-10 relative">
            ...
            <h3 className="text-2xl lg:hidden">Putri dari Agus dan Ibu Tuti</h3>
            <Link
